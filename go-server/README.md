...
This is a sample template for go-server - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name go-server --query 'Stacks[].Outputs'
```
